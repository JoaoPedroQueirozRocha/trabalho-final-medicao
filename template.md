...
**Do ponto de vista de:** Pesquisador e equipes de desenvolvimento de software
**No contexto de:** Revisão de código Python por estudantes de graduação utilizando CodeRabbit (IA) versus revisão manual
...
- Linguagem Python 3.x
- Scripts e funções de 50-200 linhas de código (LOC)
- Defeitos das categorias: funcional, segurança, performance, manutenibilidade, estilo, tratamento de erros
- Ferramenta CodeRabbit para revisão com IA
- Revisão de Pull Requests em repositório GitHub controlado
- Participantes: estudantes de graduação

**Excluído do escopo:**

- Outras linguagens de programação
- Código legado ou sistemas complexos
- Revisão de arquitetura de software
- Documentação e comentários (foco em código executável)
...
| Tipo de projeto              | Exercícios controlados com defeitos inseridos (seeded) |
...
| Experiência com code review | Variável (coletada via questionário demográfico)     |

---

### 4.3 Premissas

- Os participantes possuem conhecimento suficiente de Python para identificar defeitos básicos
- O CodeRabbit estará disponível e funcional durante todo o experimento
- Os defeitos inseridos nos códigos são representativos de defeitos reais
- O GitHub funcionará sem interrupções significativas
- Os participantes dedicarão atenção genuína às tarefas
- O tempo disponível será suficiente para completar as revisões

---

### 4.4 Restrições

- **Tempo limitado:** Experimento deve ser concluído dentro do semestre letivo
- **Orçamento:** Utilização apenas do tier gratuito do CodeRabbit
- **Participantes:** Limitado a estudantes disponíveis e voluntários
- **Ambiente:** Repositórios públicos no GitHub (requisito do tier gratuito)
- **Infraestrutura:** Dependência de conexão com internet estável
...
**Hipótese Principal (H1) - Detecção de defeitos:**
...
**Hipótese Secundária (H2) - Tempo de revisão:**
...
**Hipótese Secundária (H3) - Falsos positivos:**
...
**Hipótese Secundária (H4) - Abordagem híbrida:**
...
| ----------------------- | ------------------------------ | -------- | ---- |
| Comitê de Ética (CEP) | [Nome do CEP da instituição] | Pendente | -    |
...
| Brindes para sorteio (opcional) | R$ 100-200           | Recursos próprios     |
| **Total estimado**        | **R$ 50-300**  | -                      |
...
| ------------------------------------------------ | ------------- | ------------ |
| Plano de experimento concluído                  | [Data]        | Em andamento |
| Aprovação do orientador                        | [Data]        | Pendente     |
| Submissão ao CEP (se necessário)               | [Data]        | Pendente     |
| Desenvolvimento dos artefatos de código         | [Data]        | Pendente     |
| Desenvolvimento dos instrumentos                 | [Data]        | Pendente     |
| Configuração do ambiente (GitHub + CodeRabbit) | [Data]        | Pendente     |
| Recrutamento de participantes                    | [Data]        | Pendente     |
| Execução do piloto                             | [Data]        | Pendente     |
| Ajustes pós-piloto                              | [Data]        | Pendente     |
| Início da execução principal                  | [Data]        | Pendente     |
...
**Repositório principal:** GitHub - [URL do repositório]
...
| [CEP - se aplicável] | Comitê de Ética | Parecer consubstanciado | Pendente |
